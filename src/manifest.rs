...
impl Manifest {
    /// Load a manifest from a project directory containing a `gooey.toml` file.
...
pub struct Package {
    ...
    /// by gooey and hidden files/directories. If include is specified then only
    ...
    /// will be respected and gooey will also ignore those files.
    ///
    /// Example: ["/src", "*.lua"]
    #[serde(default)]
    ...
    ///
    /// By default files generated by gooey and hidden files/directories will be
    /// excluded. If a .gitignore file exists and include is unspecified then
    /// those patterns will be respected and gooey will also ignore those files.
