...
pub const MANIFEST_FILE_NAME: &str = "rbxpm.toml";

/// The contents of a `rbxpm.toml` file, which defines a package.
...
impl Manifest {
    /// Load a manifest from a project directory containing a `rbxpm.toml` file.
...
pub struct Package {
    ...
    /// by rbxpm and hidden files/directories. If include is specified then only
    ...
    /// will be respected and rbxpm will also ignore those files.
    ///
    /// Example: ["/src", "*.lua"]
    #[serde(default)]
    ...
    ///
    /// By default files generated by rbxpm and hidden files/directories will be
    /// excluded. If a .gitignore file exists and include is unspecified then
    /// those patterns will be respected and rbxpm will also ignore those files.
