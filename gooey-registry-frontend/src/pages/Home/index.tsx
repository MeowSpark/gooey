  ...
  return (
    <>
      <ContentSection variation="red" placement="floating">
        <Heading>gooey, a package manager for Roblox</Heading>
        <ResponsiveParagraph>
          gooey is a package manager for Roblox inspired by Cargo (Rust) and npm
        ...
        <ResponsiveParagraph>
          gooey has two pieces that work together: a command line tool named{" "}
          <Code>gooey</Code> and a registry server that hosts packages. Most
          users will only interact with the command line tool, but both are
          available in this repository.
        </ResponsiveParagraph>

        <CallToActionContainer>
          <ButtonLink to="install">Install gooey</ButtonLink>
        </CallToActionContainer>
      </ContentSection>
